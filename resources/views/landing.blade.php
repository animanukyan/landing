            ...
            <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                ...
                <form class="my-8 md:my-12 max-w-lg">
                    <div class="mt-1 flex flex-wrap sm:flex-nowrap">
                        <input type="email" id="email" name="email" placeholder="Email address" class="block w-full py-4 px-4 rounded sm:rounded-r-none border border-emerald-500 focus:border-emerald-500 focus:ring-0 focus:ring-emerald-500 sm:text-lg" />
                        <button
                            type="submit"
