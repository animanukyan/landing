@extends('app') @section('content')
    <section class="bg-emerald-400">
        <div class="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 text-center">
            <h1 class="pt-20 lg:pt-28 lg:pb-20 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white dark:text-white ">Your Data Insights Strategist</h1>
