<div>
    <form wire:submit="save" class="mt-8 max-w-lg">
        <div class="mt-1 flex flex-wrap sm:flex-nowrap">
            ...
            <button
                type="submit"
                class="mt-4 sm:mt-0 rounded sm:rounded-l-none bg-emerald-500 px-7 py-2.5 text-md font-semibold text-white shadow-sm hover:bg-emerald-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-400"
            >
                Subscribe
            </button>
        </div>
